...
struct old_ListHeartBeatsView: View {
  ...
  let items: [CardItem] = [
    CardItem(
      name: "たろう", imageName: "taro", iconImageName: "heart_beat", detailImageName: "detail_pic"),
    CardItem(
      name: "るい", imageName: "taro", iconImageName: "heart_beat", detailImageName: "detail_pic"),
    CardItem(
      name: "あやか", imageName: "taro", iconImageName: "heart_beat", detailImageName: "detail_pic"),
    CardItem(
